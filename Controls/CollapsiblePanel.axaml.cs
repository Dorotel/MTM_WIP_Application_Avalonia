...
public partial class CollapsiblePanel : UserControl
{
    ...
    private void SetupLeftHeader()
    {
        ...
        if (_headerArea != null) Grid.SetColumn(_headerArea, 0);
        if (_contentArea != null) Grid.SetColumn(_contentArea, 1);
        
        _headerArea?.SetValue(Border.BorderThicknessProperty, new Avalonia.Thickness(0, 0, 1, 0));
        _headerArea?.SetValue(Border.CornerRadiusProperty, new Avalonia.CornerRadius(8, 0, 0, 8)); // Left side rounded corners
        if (_headerArea != null)
        {
    ...
    private void SetupRightHeader()
    {
        ...
        if (_contentArea != null) Grid.SetColumn(_contentArea, 0);
        if (_headerArea != null) Grid.SetColumn(_headerArea, 1);
        
        _headerArea?.SetValue(Border.BorderThicknessProperty, new Avalonia.Thickness(1, 0, 0, 0));
        _headerArea?.SetValue(Border.CornerRadiusProperty, new Avalonia.CornerRadius(0, 8, 8, 0)); // Right side rounded corners
        if (_headerArea != null)
        {
            _headerArea.Width = 40;
            _headerArea.Height = double.NaN;
    ...
    private void SetupTopHeader()
    {
        ...
        if (_headerArea != null) Grid.SetRow(_headerArea, 0);
        if (_contentArea != null) Grid.SetRow(_contentArea, 1);
        
        _headerArea?.SetValue(Border.BorderThicknessProperty, new Avalonia.Thickness(0, 0, 0, 1));
        _headerArea?.SetValue(Border.CornerRadiusProperty, new Avalonia.CornerRadius(8, 8, 0, 0)); // Top rounded corners
        if (_headerArea != null)
        {
    ...
    private void SetupBottomHeader()
    {
        ...
        if (_contentArea != null) Grid.SetRow(_contentArea, 0);
        if (_headerArea != null) Grid.SetRow(_headerArea, 1);
        
        _headerArea?.SetValue(Border.BorderThicknessProperty, new Avalonia.Thickness(0, 1, 0, 0));
        _headerArea?.SetValue(Border.CornerRadiusProperty, new Avalonia.CornerRadius(0, 0, 8, 8)); // Bottom rounded corners
        if (_headerArea != null)
        {
            _headerArea.Width = double.NaN;
            _headerArea.Height = 40;
