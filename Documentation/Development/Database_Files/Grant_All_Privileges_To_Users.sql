-- ================================================================
-- MTM WIP Application - Grant ALL PRIVILEGES to Existing Users
-- For MySQL 5.7 and phpMyAdmin compatibility
-- ================================================================
-- 
...
--
-- To test: Try connecting as one of the users and run:
-- SHOW DATABASES;
